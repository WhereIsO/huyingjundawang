// BackupTool core module notes: binary_io.h
...
public:
    ...
    void zstring(const std::string& value);
    [[nodiscard]] const std::vector<std::uint8_t>& data() const { return bytes_; }
    [[nodiscard]] std::vector<std::uint8_t>& data() { return bytes_; }
...
public:
    ...
    [[nodiscard]] bool eof() const { return offset_ >= data_.size(); }
