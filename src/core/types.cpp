// BackupTool core module notes: types.cpp
...
const char* stageName(Stage stage) {
    ...
    case Stage::Filtering: return "Filtering";
    case Stage::Writing: return "Writing";
    case Stage::Verifying: return "Verifying";
    case Stage::Restoring: return "Restoring";
...
std::string entryTypeName(EntryType type) {
    ...
    case EntryType::EmptyDir: return "emptydir";
    case EntryType::Symlink: return "symlink";
    case EntryType::Hardlink: return "hardlink";
    case EntryType::Junction: return "junction";
    case EntryType::ReparsePoint: return "reparse";
    }
    return "unknown";
}
